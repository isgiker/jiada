...
class Watermark {
    ...
    var $logo_image_transition = 25;   //透明度设置,水印图片与原图片的融合度(1=100)  
...
//$imglogo->logo_text_font = "./simsun.ttc"; //字体  
...
$imglogo = new Watermark(); 
$imglogo->logo_image_name = 'logo.jpg';//水印图片
$imglogo->output_image_file ="./result.jpg";//生成水印后的图片
$imglogo->input_image_file = "upload/2011/11/2011112303191370.jpg";//原图片;
$imglogo->create();  
 */
